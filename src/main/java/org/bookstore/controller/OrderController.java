...
public class OrderController {
    ...
    @Operation(summary = "Creating an order", description = """
    ...
    @Operation(summary = "Get order history", description = """
    ...
    @Operation(summary = "Update order status", description = """
                    Update order status. Parameters: order id and status""")
    @PatchMapping("/{id}")
    ...
    public UpdateOrderResponseDto updateOrderStatus(@PathVariable @Positive Long id,
        ...
        return orderService.updateStatus(id, orderDto);
    }

    @Operation(summary = "Get list of order items", description = """
                    Get list of order items of a user.
                    Parameters: order id""")
    ...
    public List<OrderItemDto> findOrderItemsByOrder(@PathVariable @Positive Long orderId,
        ...
        User user = (User) authentication.getPrincipal();
        return orderService.findAllItemsByOrder(user.getId(), orderId);
    }

    @Operation(summary = "Get order item by its id",
            description = """
